...
| `11 Collect diagnostics (FIFA 15).command` | The same collection, for the Aurora15 bottle. | no |
| `12 Check the install (FIFA 15).command` | Checks the FIFA 15 setup. | no |
...
Each command is `./setup.sh` with one flag, run from the folder above this one:
    ...
    ./setup.sh --offline-menu  ./setup.sh --fifa15 --verify
